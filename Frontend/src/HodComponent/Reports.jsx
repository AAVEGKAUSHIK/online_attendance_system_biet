  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-[anzo2] text-[#2D62BD]">Attendance Reports</h2>
        <select
      ...
      <div className="bg-white/20 p-6 rounded-lg">
        <h3 className="text-xl font-semibold text-black/70 mb-4">Teacher Attendance</h3>
      ...
      <div className="bg-white/20 p-6 rounded-lg">
        <h3 className="text-xl font-semibold text-black/70 mb-4">Student Attendance by Semester</h3>
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
