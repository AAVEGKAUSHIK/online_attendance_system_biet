...
import { AttendanceChart } from '../StudentComponent/AttendanceChart';
import { LeaveApplicationPage } from '../StudentComponent/LeaveApplicationPage';
import { NotificationPanel } from '../StudentComponent/NotificationPanel';
...
const notifications = [
  {
    id: '1',
    message: 'Your attendance in Physics is below 85%. Please improve your attendance.',
    type: 'warning',
    date: '2024-03-15',
  },
  {
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                {subjects.map((subject) => {
                  const percentage = Math.round((subject.attendance / subject.totalClasses) * 100);
                  return (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                {currentPage === 'dashboard' ? 'Dashboard' : 'Leave Application'}
              </h1>
